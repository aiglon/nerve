...
<html>
        <% 
            ...
            try
            {
                ...
                User[] ajouter=fg.getalluser(idgroupe);
                int nombredemande=bdd.nombredemande();
                int taille=ajouter.length;
        %>
    <head>
        <meta charset="utf-8"/>
        ...
        <div class="page row">
            <div class="col-md-3 side-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="defi.jsp?id=<%out.print(idgroupe);%>&type=groupe" class="btnStyle"><i class="fa fa-newspaper-o iconStyle"></i>Defi en attente groupe(<%out.print(defiattentegroupe);%>)</a>
                    </li>
                    <li>
            ...
            <div class="col-md-8">
                ...
                <div class="vidPane">
                    <div class="row">
                        <a class="col-md-10" href="detail.jsp?page=1&id=<%out.print(ajouter[i].getIduser());%>" > <h4><%out.print(ajouter[i].getPseudo()+" >");%></h4>  </a>
                    </div>             
                    <div class="row">
                        <div class="col-md-4">
                            <a href="verification/ajoutermembre.jsp?idgroupe=<%out.print(idgroupe);%>&id=<%out.print(ajouter[i].getIduser());%>" class="btn btn-success " >Ajouter membre</a>
                        </div>
                    </div>
                        <hr>
                </div>

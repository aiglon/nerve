...
<html>
        <% 
            ...
            try
            {
                ...
                String iduserconect=(String)request.getSession().getAttribute("iduser");
                int nombregroupe=fg.nombredegroupe(iduserconect);
                int defiattente=fd.nombredefiattente(iduserconect,"perso");
                int definonfini=fd.getnombredefinonfini(String.valueOf(iduser),"perso");
        ...
        <div class="page row">
            <div class="col-md-3 side-menu">
                ...
                <ul>
                    ...
                    <li>
                        <a href="defi.jsp?id=<%out.print(iduserconect);%>&type=perso" class="btnStyle"><i class="fa fa-newspaper-o iconStyle"></i>Defi en attente(<%out.print(defiattente);%>)</a>
                    </li>
                    <li>
            ...
            <div class="col-md-8">
                <%if(Integer.parseInt(iduserconect)!=iduser){%>
                <div class="vidPane">
                    <form action="verification/envoye.jsp" method="post" class="form-group">                      
                        ...
                        <input style="display: inline-block;" class="" type="hidden" name="destinataire" value="<%out.print(iduser);%>"/>
                        <input style="display: inline-block;" class="" type="hidden" name="typedestinataire" value="perso"/>
                    </form>
                </div>

...
<html>
        <% 
            ...
            try
            {
                ...
                Defiajouer[] daj=fd.getdefinonfini(idgroupe, "groupe");
            ...
            <div class="col-md-8">
                ...
                <div class="vidPane">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="Uploadergroupe" method="post" enctype="multipart/form-data" class="form-group">       
                                ...
                                <input style="" class="" type="hidden" name="idgroupe" value="<%out.print(idgroupe);%>"/>
                            </form>
                        </div>
                    </div>
                        <hr>

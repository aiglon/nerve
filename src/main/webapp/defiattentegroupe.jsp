...
<html>
        <% 
            ...
            try
            {
                ...
                int defiattentegroupe=fd.nombredefiattente(idgroupe,type);
                int definonfini=fd.getnombredefinonfini(iduser,type);
                int definonfinigroupe=fd.getnombredefinonfini(idgroupe,type);
                Defiajouer[] daj=fd.getdefienattente(idgroupe, type);
